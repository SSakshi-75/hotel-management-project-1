<%@ Page Title="Manage Hotel & Suites | Executive Admin" Language="C#" MasterPageFile="~/admin/AdminMaster.master"
    AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeFile="ManageHotel.aspx.cs"
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="AdminContent" Runat="Server">
        ...
        <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3 mb-4">
            <div>
                ...
                <p class="text-muted small mb-0">Overview of all hotel room inventories, tariffs, specifications, and
                    live guest portal publishing.</p>
            </div>
        ...
        <div class="manage-hotel-card">
                ...
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-12 col-md-5 col-lg-4">
                        <div class="search-wrap-luxury">
                            ...
                            <input type="text" id="txtHotelSearch" class="form-control form-control-luxury-search"
                                placeholder="Search room name, category, specs, ID..." onkeyup="filterHotelTable();" />
                        </div>
                    </div>

                    <!-- Category Filter Pills (Dynamically loaded from Database) -->
                    <div class="col-12 col-md-7 col-lg-6">
                        <div class="d-flex align-items-center flex-wrap gap-2">
                            <button type="button" class="filter-pill-btn active"
                                onclick="setCategoryFilter('ALL', this); return false;">
                                All Suites
                            </button>
                            <asp:Repeater ID="rptCategoryFilters" runat="server">
                                <ItemTemplate>
                                    <button type="button" class="filter-pill-btn" data-category='<%# Eval("CategoryName") %>'
                                        onclick="setCategoryFilter(this); return false;">
                                        <%# Eval("CategoryName") %>
                                    </button>
                                </ItemTemplate>
                            </asp:Repeater>
                    ...
                    <div class="col-12 col-lg-2 text-lg-end">
                        <asp:Button ID="btnBulkDelete" runat="server" CssClass="btn-hotel-delete-selected"
                            Text="Delete Selected" OnClick="btnBulkDelete_Click"
            ...
            <div class="table-responsive">
                <asp:GridView ID="grdrooms" runat="server" AutoGenerateColumns="false" DataKeyNames="RoomID"
                    ClientIDMode="Static" CssClass="table table-bordered table-hover hotel-rooms-table align-middle"
                    GridLines="Both" UseAccessibleHeader="true" AllowPaging="true" PageSize="10"
                    OnPreRender="grdrooms_PreRender" OnPageIndexChanging="grdrooms_PageIndexChanging"
                    OnRowDataBound="grdrooms_RowDataBound" OnRowCommand="grdrooms_RowCommand"
                                ...
                                <HeaderTemplate>
                                    <div class="text-center">
                                        <asp:CheckBox ID="chkSelectAll" runat="server" CssClass="hotel-chk-custom"
                                            onclick="toggleSelectAllRooms(this);" ToolTip="Select All" />
                                    </div>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <div class="text-center">
                                        <asp:CheckBox ID="chkRoomSelect" runat="server"
                                            CssClass="hotel-chk-custom room-row-chk" />
                                    </div>
                                </ItemTemplate>
                            ...
                            <%-- PREVIEW IMAGE --%>
                                <asp:TemplateField HeaderText="Preview">
                                    <ItemTemplate>
                                        <div class="room-thumb-wrap">
                                            <a href='<%# ResolveUrl("~/RoomDetails.aspx?RoomId=" + Eval("RoomID")) %>'
                                                target="_blank" title="View Room">
                                                <asp:Image ID="imgRoom" runat="server" CssClass="hotel-room-thumb"
                                                    ImageUrl='<%# GetRoomImage(Eval("PrimaryRoomImage")) %>'
                                                    AlternateText='<%# Eval("RoomName") %>' />
                                            </a>
                                        </div>
                                    </ItemTemplate>
                                ...
                                <%-- ROOM DETAILS --%>
                                    <asp:TemplateField HeaderText="Room &amp; Suite Details">
                                        <ItemTemplate>
                                            <a href='<%# ResolveUrl("~/RoomDetails.aspx?RoomId=" + Eval("RoomID")) %>'
                                                target="_blank" class="room-name-heading">
                                                <%# Eval("RoomName") %>
                                            </a>
                                                    ...
                                                    <asp:TemplateField HeaderText="Actions">
                                                        <ItemTemplate>
                                                            <div class="hotel-table-actions justify-content-center">
                                                                ...
                                                                <a href='<%# "DeleteRoom.aspx?RoomId=" + Eval("RoomID") %>'
                                                                    class="btn-action-luxury btn-delete"
                                                                    title="Delete Room">
            ...
            <div class="manage-hotel-footer">
                ...
                <div>
                    <a href="../Room.aspx" target="_blank" class="text-decoration-none fw-semibold"
                        style="color: var(--hotel-gold-dark);">
                ...
                <div class="modal-content border-0 shadow-lg" style="border-radius: 18px; overflow: hidden;">
                    <div class="modal-body p-4 text-center">
                        ...
                        <div class="mx-auto mb-3 d-flex align-items-center justify-content-center"
                            style="width: 62px; height: 62px; border-radius: 50%; background-color: #fef2f2; color: #dc2626; border: 1px solid #fee2e2;">
                            <i class="bi bi-exclamation-triangle-fill" style="font-size: 1.85rem;"></i>
                        </div>

                        <h5 class="modal-title fw-bold text-dark mb-2" id="deleteConfirmModalLabel">Delete Room
                            Confirmation</h5>
                        ...
                        <div class="p-3 mb-3 text-center rounded-3"
                            ...
                            <span class="d-block text-uppercase fw-bold text-muted mb-1"
                                style="font-size: 0.72rem; letter-spacing: 0.5px;">Selected Room</span>
                    ...
                    <div class="modal-footer border-0 bg-light px-4 py-3 justify-content-center gap-2">
                        <button type="button"
                            class="btn btn-light px-4 py-2 fw-semibold text-secondary border rounded-3"
                            data-bs-dismiss="modal">
                            Cancel
                        </button>
                        <asp:Button ID="btnConfirmDeleteRoom" runat="server" Text="Delete Room"
                            CssClass="btn btn-danger px-4 py-2 fw-semibold rounded-3 shadow-sm"
                            OnClick="btnConfirmDeleteRoom_Click" />
                    </div>
                </div>
            </div>
        </div>
