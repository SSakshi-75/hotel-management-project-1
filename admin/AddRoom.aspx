                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="text" id="txtRoomName" name="txtRoomName" class="form-control form-control-admin"
                            placeholder="e.g. Executive Business Suite" value="">
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" id="txtBadge" name="txtBadge" class="form-control form-control-admin"
                            placeholder="e.g. EXECUTIVE" value="">
                    </div>

                    <div class="col-md-4">
                        <label class="form-label-custom" for="txtRating">Rating Score (Out of 5.0)</label>
                        <input type="text" id="txtRating" name="txtRating" class="form-control form-control-admin"
                            placeholder="e.g. 4.9" value="">
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" id="txtMaxAdults" name="txtMaxAdults" class="form-control form-control-admin"
                            placeholder="e.g. 2 Guests" value="">
                    </div>

                    <div class="col-md-4">
                        <label class="form-label-custom" for="txtArea">Room Size / Area</label>
                        <input type="text" id="txtArea" name="txtArea" class="form-control form-control-admin"
                            placeholder="e.g. 55 m²" value="">
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" id="txtViewType" name="txtViewType" class="form-control form-control-admin"
                            placeholder="e.g. City View, Garden View, Pool View" value="">
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            <label class="amenity-pill">
                                <input type="checkbox" name="amenities" class="d-none" value="High-Speed Wi-Fi">
                                <i class="bi bi-wifi text-gold"></i> <span>High-Speed Wi-Fi</span>
                            </label>
                            <label class="amenity-pill">
                                <input type="checkbox" name="amenities" class="d-none" value="Work Desk">
                                <i class="bi bi-laptop text-gold"></i> <span>Work Desk</span>
                            </label>
                            <label class="amenity-pill">
                                <input type="checkbox" name="amenities" class="d-none" value="Coffee Maker">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" id="txtHeaderBadge" name="txtHeaderBadge"
                            class="form-control form-control-admin" placeholder="e.g. ROYAL ACCOMMODATION" value="">
                    </div>

                    <div class="col-md-8">
                        <label class="form-label-custom" for="txtHeaderTitle">Page Hero Title</label>
                        <input type="text" id="txtHeaderTitle" name="txtHeaderTitle"
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" id="txtHeaderSubtitle" name="txtHeaderSubtitle"
                            class="form-control form-control-admin"
                            placeholder="Tagline displayed on room details hero..." value="">
                    </div>
                    ...
                    <div class="col-12">
                        <label class="form-label-custom" for="txtFullOverview">Detailed Room Overview (Full Page
                            Description)</label>
                        <textarea id="txtFullOverview" name="txtFullOverview" class="form-control form-control-admin"
                            rows="3"
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" id="txtHighlights" name="txtHighlights"
                            class="form-control form-control-admin"
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="text" id="txtReviewQuote" name="txtReviewQuote"
                            class="form-control form-control-admin"
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" id="txtReviewAuthor" name="txtReviewAuthor"
